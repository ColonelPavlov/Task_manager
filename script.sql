...
CREATE TABLE `time_tracking` (
  ...
  KEY `user_id` (`user_id`),
  KEY `task_id` (`task_id`),
  CONSTRAINT `time_tracking_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `time_tracking_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`task_id`)
